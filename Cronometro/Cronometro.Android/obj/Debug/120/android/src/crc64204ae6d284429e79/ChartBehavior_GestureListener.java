...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.ChartBehavior+GestureListener, Syncfusion.SfChart.XForms.Android", ChartBehavior_GestureListener.class, __md_methods);
	}
	...
	public ChartBehavior_GestureListener ()
	{
		...
		if (getClass () == ChartBehavior_GestureListener.class) {
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.ChartBehavior+GestureListener, Syncfusion.SfChart.XForms.Android", "", this, new java.lang.Object[] {  });
		}
	}
